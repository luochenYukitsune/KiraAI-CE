window._locale_en = {
    ...
    provider: {
        ...
        test_modal_title: "Test Model",
        test_testing: "Testing model...",
        test_success: "Test Successful",
        test_failed: "Test Failed",
        test_response_time: "Response Time",
        test_status_code: "Status Code",
        test_response: "Response:",
        test_embedding_dim: "Embedding Dimension",
        test_data_count: "Data Count",
        test_image_url: "Image URL:",
        test_prompt_tokens: "Prompt",
        test_completion_tokens: "Completion",
        test_total_tokens: "Total",
        test_error_type: "Error Type",
        test_suggestion: "Suggestion",
        test_close: "Close",
        test_network_error: "Could not connect to the server. Please check your network connection."
    },
    adapter: {
        title: "Adapters",
        add: "Add Adapter",
    ...
    settings: {
        ...
        background_music_title: "Background Music",
        background_music_enabled: "Enable Background Music",
        background_music_enabled_desc: "Play background music while using the application",
        background_music_source: "Music Source",
        background_music_url: "Music URL",
        background_music_url_placeholder: "https://example.com/music.mp3",
        background_music_url_hint: "Enter a direct link to an audio file (MP3, WAV, OGG)",
        background_music_apply: "Apply",
        background_music_or: "or",
        background_music_upload: "Upload Local File",
        background_music_local_files: "Local Music Files",
        background_music_select_file: "Select a file...",
        background_music_uploading: "Uploading file...",
        background_music_upload_success: "File uploaded successfully",
        background_music_upload_error: "Failed to upload file",
        background_music_volume: "Volume",
        background_music_loop: "Loop Playback",
        background_music_stopped: "Stopped",
        background_music_playing: "Playing",
        background_music_no_source: "No music source",
        background_music_load_error: "Failed to load audio file",
        background_music_url_required: "Please enter a valid URL",
        background_music_url_applied: "Music URL applied",
        background_music_no_url: "Please set a music URL first",
        background_music_play_error: "Failed to play audio"
    },
    dropzone: {

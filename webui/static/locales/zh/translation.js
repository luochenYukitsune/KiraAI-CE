window._locale_zh = {
    ...
    provider: {
        ...
        test_response: "响应内容：",
        test_embedding_dim: "向量维度",
        test_data_count: "数据数量",
        test_image_url: "图片地址：",
        test_prompt_tokens: "提示词",
        test_completion_tokens: "补全",
        test_total_tokens: "总计",
        test_error_type: "错误类型",
        test_suggestion: "建议",
        test_close: "关闭",
        test_network_error: "无法连接到服务器，请检查网络连接。"
    },
    adapter: {
        title: "适配器",
        add: "添加适配器",
    ...
    settings: {
        ...
        save: "保存设置",
        saved: "设置保存成功",
        background_music_title: "背景音乐",
        background_music_enabled: "启用背景音乐",
        background_music_enabled_desc: "在使用应用时播放背景音乐",
        background_music_source: "音乐来源",
        background_music_url: "音乐地址",
        background_music_url_placeholder: "https://example.com/music.mp3",
        background_music_url_hint: "输入音频文件的直接链接（支持 MP3、WAV、OGG）",
        background_music_apply: "应用",
        background_music_or: "或",
        background_music_upload: "上传本地文件",
        background_music_local_files: "本地音乐文件",
        background_music_select_file: "选择文件...",
        background_music_uploading: "正在上传文件...",
        background_music_upload_success: "文件上传成功",
        background_music_upload_error: "文件上传失败",
        background_music_volume: "音量",
        background_music_loop: "循环播放",
        background_music_stopped: "已停止",
        background_music_playing: "播放中",
        background_music_no_source: "未设置音乐源",
        background_music_load_error: "加载音频文件失败",
        background_music_url_required: "请输入有效的 URL",
        background_music_url_applied: "音乐地址已应用",
        background_music_no_url: "请先设置音乐地址",
        background_music_play_error: "播放音频失败"
    },
    dropzone: {

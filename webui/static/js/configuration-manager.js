...
class ConfigurationManager {
    ...
    getSchema() {
        return [
            ...
            },
            {
                ...
                fields: [
                    {
                        key: 'framework.developer_mode',
                        labelKey: 'configuration.framework.developer_mode',
                        labelFallback: 'Developer Mode',
                        hintKey: 'configuration.hints.developer_mode',
                        hintFallback: 'Enable detailed workflow logs. Unless you know what you are doing, do not enable this.',
                        type: 'switch',
                        default: false,
                        validation: { required: false }
                    }
    ...
    async save() {
        ...
        try {
            ...
            const framework = this._getNestedValue(this.currentData, 'framework') || {};
